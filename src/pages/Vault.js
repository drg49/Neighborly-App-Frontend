...
const Vault = (props) => {
  ...
  const message = (
    <p id="nullMessage">Be the first to post in your neighborhood!</p>
  );
  ...
  return (
    <>
      ...
      <button onClick={handleFormClick}>Create a Post</button>
      <br />
      {posts ? (
        posts.length === 0 ? (
          message
        ...
        <Spinner width={160} text="Posts are loading" />
      )}
    </>
  );
};
